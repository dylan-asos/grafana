...
require (
	buf.build/gen/go/parca-dev/parca/bufbuild/connect-go v1.10.0-20260413103946-e19e4fde69b5.2 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.31.0-20260413103946-e19e4fde69b5.2 // @grafana/observability-traces-and-profiling
