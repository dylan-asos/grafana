...
require (
	...
	google.golang.org/api v0.134.0 // @grafana/backend-platform
	google.golang.org/grpc v1.56.2 // @grafana/plugins-platform-backend
...
require (
	...
	google.golang.org/genproto v0.0.0-20230706204954-ccb25ca9f130 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.12.1 // @grafana/backend-platform
