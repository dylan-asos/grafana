...
require (
	...
	github.com/aws/aws-sdk-go v1.49.6 // @grafana/aws-datasources
	...
	golang.org/x/crypto v0.20.0 // @grafana/backend-platform
	golang.org/x/exp v0.0.0-20230321023759-10a507213a29 // @grafana/alerting-squad-backend
	golang.org/x/net v0.21.0 // @grafana/grafana-bi-squad
...
require (
	...
	github.com/docker/docker v24.0.9+incompatible // @grafana/grafana-delivery
