...
require (
	...
	github.com/go-openapi/strfmt v0.24.0 // @grafana/alerting-squad-backend
	...
	github.com/prometheus/common v0.67.1 // @grafana/alerting-squad-backend
	...
	github.com/urfave/cli/v2 v2.25.1 // @grafana/backend-platform
	...
	golang.org/x/exp v0.0.0-20251002181428-27f1f14c8bb9 // @grafana/alerting-squad-backend
	golang.org/x/net v0.44.0 // @grafana/grafana-bi-squad
	...
	google.golang.org/api v0.230.0 // @grafana/backend-platform
...
require (
	...
	github.com/go-openapi/loads v0.23.1 // @grafana/alerting-squad-backend
	...
	google.golang.org/genproto v0.0.0-20250303144028-a0af3efb3deb // indirect; @grafana/backend-platform
)
...
require (
	...
	github.com/getkin/kin-openapi v0.133.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.38.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.32.0 // @grafana/backend-platform
