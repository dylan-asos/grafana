...
require (
	...
	github.com/stretchr/testify v1.11.0 // @grafana/backend-platform
	...
	golang.org/x/net v0.41.0 // @grafana/grafana-bi-squad
...
require (
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.36.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.36.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.36.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.30.0 // @grafana/backend-platform
