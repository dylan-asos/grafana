...
require (
	...
	github.com/go-git/go-git/v5 v5.19.2 // @grafana/grafana-app-platform-squad
	...
	golang.org/x/exp v0.0.0-20260410095643-746e56fc9e2f // @grafana/alerting-squad-backend
	golang.org/x/net v0.56.0 // @grafana/grafana-bi-squad
...
require (
	...
	golang.org/x/text v0.39.0 // @grafana/backend-platform
